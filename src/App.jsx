...
const tokenModule = sdk.getTokenModule(
  "0x396e94f8daC6403DEc34dA720B5a488a2e141574"
);

const voteModule = sdk.getVoteModule(
  "0x4513779309d0dDb99CaF51D1521AA45b11cAF35b",
);
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🇱🇧LebanonDAO🇱🇧</h1>
        <p>Your are oficially a lebanonDAO member</p>
        <div>
          <div>
            <h2>Member List</h2>
